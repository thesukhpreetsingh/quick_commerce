...
import { fetchInventory, decreaseInventoryHandler, reserveInventoryHandler, releaseInventoryHandler, finalizeInventoryHandler, } from '../controllers/inventoryController.js';
const router = Router();
